...
class BeersControllerTest < ActionController::TestCase
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post :create, beer: { brand: @beer.brand, country: @beer.country, quantity: @beer.quantity, style: @beer.style }
    end
  ...
  test "should update beer" do
    patch :update, id: @beer, beer: { brand: @beer.brand, country: @beer.country, quantity: @beer.quantity, style: @beer.style }
    assert_redirected_to beer_path(assigns(:beer))
  end
